      ...
      <div class="container-fluid">
        ...
        <div v-else>
          ...
          <div class="row mb-4">
            ...
            <div class="col-xl-3 col-lg-6 col-md-6 mb-3">
              <div class="stat-card stat-offline" @click="showOfflineModal = true" style="cursor:pointer">
            ...
            <div class="col-xl-3 col-lg-6 col-md-6 mb-3">
              <div class="stat-card stat-requests">
                ...
                <div class="stat-content">
                  ...
                  <div class="stat-detail">
                    <span>{{ selectedUser ? 'Filtrées' : 'Total du jour' }}</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="col-xl-3 col-lg-6 col-md-6 mb-3">
              <div class="stat-card stat-peak">
                ...
                <div class="stat-content">
                  ...
                  <div class="stat-detail">
                    <span>{{ analytics.peakHourRequests }} requêtes</span>
                  </div>
                </div>
              </div>
            </div>
