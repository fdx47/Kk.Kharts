...
//    <meta charset=""utf-8"" />
//    <meta name=""viewport"" content=""width=device-width, initial-scale=1"" />
//    <title>Swagger – Autenticação</title>
//    <style>
//        * { box-sizing: border-box; margin: 0; padding: 0; }
//        body {
//            font-family: 'Segoe UI', system-ui, -apple-system, sans-serif;
...
//<body>
//    <div class=""card"">
//        <h1>🔒 Swagger Protegido</h1>
//        <p class=""sub"">Introduza as credenciais de administrador para aceder à documentação da API.</p>
//        <form method=""post"" action=""/swagger/login"">
//            {{ERROR}}
...
//        </form>
//        <div class=""footer"">KropKontrol &copy; 2026</div>
//    </div>
//</body>
//</html>";
//}
